...
public:
	...
	vector<cv::Point2f> point_2d_uv;          // 原来的特征点
	vector<cv::Point2f> point_2d_norm;
	vector<double> point_id;	
	vector<cv::KeyPoint> window_keypoints;    // 原来光流追踪的特征点
	vector<cv::KeyPoint> keypoints;	      // 额外提取的fast角点的像素坐标
	vector<cv::KeyPoint> keypoints_norm;	// 额外提取的fast角点对应的归一化相机系坐标
